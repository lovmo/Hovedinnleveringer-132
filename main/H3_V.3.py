...
def printer(utdata):
    ...
    :return:
    """
    print('\n{:^4s}{:^4s}{:^4s}{:^4s}{:^4s}{:^4s}{:^4s}{:^4s}'.format(utdata[0][0], utdata[1][0], utdata[2][0],
    ...
    print('{:^4d}{:^4d}{:^4d}{:^4d}{:^4d}{:^4d}{:^4d}{:^4d}\n'.format(utdata[0][2], utdata[1][2], utdata[2][2],
    ...
    while True:
        ...
        if len(kontroll_liste) > len(set(kontroll_liste)):
            ...
            if valg1 == 'X':
                ...
                print('\nDu har ikke valgt et gydlig par')
